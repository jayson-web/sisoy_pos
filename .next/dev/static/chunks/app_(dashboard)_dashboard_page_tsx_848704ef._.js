                ...
                "DashboardPage.useEffect.syncBookingsFromServer": async ()=>{
                    try {
                        ...
                        if (res.ok) {
                            ...
                            // Convert server format to client Booking format (keep customer and transaction info)
                            const convertedBookings = serverBookings.map({
                                "DashboardPage.useEffect.syncBookingsFromServer.convertedBookings": (b)=>({
                                        ...
                                        customerName: b.first_name || b.last_name ? `${b.first_name || ''}${b.first_name && b.last_name ? ' ' : ''}${b.last_name || ''}`.trim() : undefined,
                                        transactionId: b.transaction_reference || b.transactionId || undefined,
                                        transactionAmount: b.transaction_amount ? parseFloat(b.transaction_amount) : undefined
                                    })
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    ...
                                                                    children: b.customerName || __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["storage"].getClients().find((c)=>c.id === b.clientId)?.firstName || "N/A"
                                                                }, void 0, false, {
                                                                    fileName: "[project]/app/(dashboard)/dashboard/page.tsx",
                                                                    lineNumber: 145,
                                                                    columnNumber: 23
